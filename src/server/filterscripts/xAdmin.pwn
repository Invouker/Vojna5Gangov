...
stock HaveAdmin(playerid, Adminlevel){
	if(AInfo[playerid][AdminLvl] >= Adminlevel) return 0;
...
public OnPlayerConnect(playerid){
	...
	AInfo[playerid][AdminLvl] = DOF2_GetInt(UserPath(playerid),"AdminLevel");
    AInfo[playerid][AdminLvl] = 0;
